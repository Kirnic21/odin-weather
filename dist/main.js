...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Weather\": () => (/* binding */ Weather)\n/* harmony export */ });\n\nclass Weather{\n    constructor(data)\n    {\n        this.humidity = \"Fetching data...\"\n        this.tempC = \"Fetching data...\"\n        this.tempF = \"Fetching data...\"\n        this.cloud = \"Fetching data...\"\n        this.condition = \"Fetching data...\"\n    }\n  }\n  \n\n//# sourceURL=webpack://a/./src/class.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"isValidForecast\": () => (/* binding */ isValidForecast),\n/* harmony export */   \"isValidforToday\": () => (/* binding */ isValidforToday)\n/* harmony export */ });\n/* harmony import */ var _data_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./data */ \"./src/data.js\");\n\n\n\n\nfunction isValidforToday()\n{\n    const location = document.querySelector(\"#locationForm\")\n    location.addEventListener(\"submit\",async (e)=>{\n        e.preventDefault()\n    \n        const locationInput = document.querySelector(\"#inputLocation\")\n        \n        if(await (0,_data_js__WEBPACK_IMPORTED_MODULE_0__.asyncAssignTodayWeather)(locationInput.value) === false)\n        {\n        \n             await locationInput.setCustomValidity(\"Insert a valid country!!!!\")\n             await locationInput.reportValidity()\n    \n        }\n        else{\n            console.log(await (0,_data_js__WEBPACK_IMPORTED_MODULE_0__.asyncAssignTodayWeather)(locationInput.value))\n            await (0,_data_js__WEBPACK_IMPORTED_MODULE_0__.asyncAssignTodayWeather)(locationInput.value)\n            await locationInput.setCustomValidity(\"\")\n        }\n    }\n    )\n}\nfunction isValidForecast()\n{\n    const location = document.querySelector(\"#locationForm\")\n    location.addEventListener(\"submit\",async (e)=>{\n        e.preventDefault()\n    \n        const locationInput = document.querySelector(\"#inputLocation\")\n        \n        if(await (0,_data_js__WEBPACK_IMPORTED_MODULE_0__.asyncAssignForecast)(locationInput.value) === false)\n        {\n        \n             await locationInput.setCustomValidity(\"Insert a valid country!!!!\")\n             await locationInput.reportValidity()\n    \n        }\n        else{\n            console.log(await (0,_data_js__WEBPACK_IMPORTED_MODULE_0__.asyncAssignTodayWeather)(locationInput.value))\n            await (0,_data_js__WEBPACK_IMPORTED_MODULE_0__.asyncAssignForecast)(locationInput.value)\n            await locationInput.setCustomValidity(\"\")\n        }\n    }\n    )\n}\n\n\n\n//# sourceURL=webpack://a/./src/validation.js?");
